	...
	this.renderBasketTable = function()
		...
		if ($('#bcontainer').length == 0)
			...
			$("body").append(" \
				...
				<table id='bcaption'><tr><td>ID</td><td><lang name='name'>" + local.name + "</lang></td><td><lang name='price'>" + local.price + "</lang></td><td><lang name='num'>" + local.num + "</lang></td><td><lang name='all'>" + local.all + "</lang></td><td></td></tr></table> \
				<div id='overflw'><table class='btable' id='btable'></table></div> \
				<div id='bfooter'> <button class='bbutton' onclick=\"cart.showWinow('order', 1)\"><lang name='order'>" + local.order + "</lang></button><span id='bsum'>...</span></div> \
				</div> \
			");	
